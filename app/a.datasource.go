...
func init() {
	...
	dbase.Connections["DBApp"].NewCommand("GetServiceSubData", "GetServiceSubData", "procedure", func(cmd dbase.ICommand) {
		cmd.NewParameter("id", "int", "in", 0, 0)
		cmd.NewParameter("service_type", "string", "in", 3, "")
	...
	dbase.Connections["DBApp"].NewCommand("GetGop", "GetGop", "procedure", func(cmd dbase.ICommand) {
		cmd.NewParameter("id", "int", "in", 0, 0)
		cmd.NewParameter("sub_type", "string", "in", 3, "")
		cmd.NewParameter("visit_id", "int", "in", 0, 0)
	})
	...
	dbase.Connections["DBApp"].NewCommand("lookup_service_sub_types", "GetServiceSubTypes", "procedure", func(cmd dbase.ICommand) {
		cmd.NewParameter("service_type", "string", "in", 3, "")
