...
func init() {
	...
	crud.Handler(crud.CrudHandler{
		...
		Action:           "action-types",
		KeyName:          "code",
		ListDataSource:   "DBApp.GetActionTypes",
		UpdateDataSource: "DBApp.AddActionTypes",
	...
	dbase.Connections["DBApp"].NewCommand("AddActionTypes", "AddActionTypes", "procedure", func(cmd dbase.ICommand) {
		cmd.NewParameter("code", "string", "inout", 3, "")
		cmd.NewParameter("action_type", "string", "in", 60, "")
