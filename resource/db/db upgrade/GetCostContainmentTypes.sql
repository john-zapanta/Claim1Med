DROP PROCEDURE [dbo].[GetCostContainmentTypes]
GO

CREATE PROCEDURE [dbo].[GetCostContainmentTypes]
-- ***************************************************************************************************
-- Last modified on
-- 
-- *************************************************************************************************** 
...
BEGIN
	...
	BEGIN
		SELECT * FROM cost_containment_types WHERE code = @code
	END ELSE
	BEGIN
