DROP PROCEDURE [dbo].[GetCustomerServiceTypes]
GO


CREATE PROCEDURE [dbo].[GetCustomerServiceTypes]
-- ***************************************************************************************************
-- Last modified on
-- 
-- *************************************************************************************************** 
...
BEGIN
	...
	BEGIN
		SELECT * FROM v_customer_service_types WHERE code = @code
	END ELSE
	BEGIN
		...
		EXEC RunSimpleDynamicQuery
			@source = 'v_customer_service_types',
			@columns = @columns,

			@filter = @filter,
			@where = '[service_description] like @filter',
